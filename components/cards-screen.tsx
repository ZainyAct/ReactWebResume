...
return (
    ...
    <div className="flex flex-wrap justify-center gap-5 max-w-7xl">
        ...
        <div
            key={index}
            className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 p-8"
            style={{ flex: "1 0 30%", maxWidth: "30%" }}
        >
            <a href={project.data.link}>
            <Image
                className="hover:animate-wiggle hover:animate-infinite text-justify object-cover w-full rounded-t-lg h-50"
